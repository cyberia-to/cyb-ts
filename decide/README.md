...
tags: cyb, core
---
# decide — pages awaiting the owner's call

nothing here is deleted; each file carries one open question. answer a question — the file moves to its shelf the same day.

| page | the question |
|---|---|
| [[cyb/decide/os|os]] (CybOS) | is a cyb operating system still the vision, or is this soft3's layer now? keep as north star, move to soft3, or park as historical? |
